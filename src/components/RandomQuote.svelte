<svelte:options tag="ts-random-quote" />
...
<script>
  ...
  export let quote = "Twenty years from now you will be more disappointed by the things that you didn’t do than by the ones you did do.";
  export let author = "Mark Twain";
  const timeSwitch = 10000;
  let hide = false;
  ...
  const generateNewQuote = async () => {
    ...
    const newQuote = quotes[getRandomInt(quotes.length - 1)];
    quote = newQuote.text;
  ...
  setInterval(generateNewQuote, timeSwitch)


</script>

<div class="quotes" class:hide>
